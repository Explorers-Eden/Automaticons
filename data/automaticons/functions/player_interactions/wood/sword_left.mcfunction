...
execute as @e[type=text_display,tag=automaticons_name_display,predicate=!nmr:entity/headmob_vehicle] run kill @s
execute as @e[type=text_display,tag=automaticons_durability_display] at @s unless data entity @s Passengers run kill @s
