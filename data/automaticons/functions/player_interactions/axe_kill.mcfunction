...
execute as @s[tag=wood] run loot give @s loot automaticons:wood/axe
execute as @s[tag=stone] run loot give @s loot automaticons:stone/axe
execute as @s[tag=gold] run loot give @s loot automaticons:gold/axe
execute as @s[tag=iron] run loot give @s loot automaticons:iron/axe
execute as @s[tag=diamond] run loot give @s loot automaticons:diamond/axe
execute as @s[tag=netherite] run loot give @s loot automaticons:netherite/axe
