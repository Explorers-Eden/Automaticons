...
execute as @s[tag=wood] run loot give @s loot automaticons:wood/hoe
execute as @s[tag=stone] run loot give @s loot automaticons:stone/hoe
execute as @s[tag=gold] run loot give @s loot automaticons:gold/hoe
execute as @s[tag=iron] run loot give @s loot automaticons:iron/hoe
execute as @s[tag=diamond] run loot give @s loot automaticons:diamond/hoe
execute as @s[tag=netherite] run loot give @s loot automaticons:netherite/hoe
