...
execute as @s[tag=wood] run loot give @s loot automaticons:wood/shovel
execute as @s[tag=stone] run loot give @s loot automaticons:stone/shovel
execute as @s[tag=gold] run loot give @s loot automaticons:gold/shovel
execute as @s[tag=iron] run loot give @s loot automaticons:iron/shovel
execute as @s[tag=diamond] run loot give @s loot automaticons:diamond/shovel
execute as @s[tag=netherite] run loot give @s loot automaticons:netherite/shovel
