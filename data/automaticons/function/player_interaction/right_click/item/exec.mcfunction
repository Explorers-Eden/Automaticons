...
execute unless items entity @s weapon.offhand #eden:automaticons_items_all run return run data modify entity @s equipment.offhand set from storage eden:temp automaticons.advancement.item
