...
execute as @s[tag=wood] run loot give @s loot automaticons:wood/sword
execute as @s[tag=stone] run loot give @s loot automaticons:stone/sword
execute as @s[tag=gold] run loot give @s loot automaticons:gold/sword
execute as @s[tag=iron] run loot give @s loot automaticons:iron/sword
execute as @s[tag=diamond] run loot give @s loot automaticons:diamond/sword
execute as @s[tag=netherite] run loot give @s loot automaticons:netherite/sword
