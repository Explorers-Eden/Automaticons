...
execute as @s[tag=wood] run loot give @s loot eden:item/automaticons/wood/sword
execute as @s[tag=stone] run loot give @s loot eden:item/automaticons/stone/sword
execute as @s[tag=gold] run loot give @s loot eden:item/automaticons/gold/sword
execute as @s[tag=iron] run loot give @s loot eden:item/automaticons/iron/sword
execute as @s[tag=diamond] run loot give @s loot eden:item/automaticons/diamond/sword
execute as @s[tag=netherite] run loot give @s loot eden:item/automaticons/netherite/sword
