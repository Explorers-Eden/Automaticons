execute as @e[type=minecraft:interaction,tag=automaticon_interaction] if data entity @s interaction unless predicate eden:automaticons/netherite_vehicle run return fail
