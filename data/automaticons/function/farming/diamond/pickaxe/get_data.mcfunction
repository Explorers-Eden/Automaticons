...
execute store result storage automaticons:farming payout_amount int 1 run random value 1..10

execute store result score @s automaticons.tool.durability.temp if items entity @s weapon.mainhand #eden:automaticons/is_low_dmg run random value 1..3
execute store result score @s automaticons.tool.durability.temp if items entity @s weapon.mainhand #eden:automaticons/is_mid_dmg run random value 4..6
execute store result score @s automaticons.tool.durability.temp if items entity @s weapon.mainhand #eden:automaticons/is_high_dmg run random value 7..9
...
function automaticons:farming/diamond/pickaxe/payout with storage automaticons:farming
