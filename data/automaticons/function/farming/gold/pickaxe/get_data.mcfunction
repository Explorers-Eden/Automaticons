...
execute store result storage automaticons:farming payout_amount int 1 run random value 1..6
...
function automaticons:farming/gold/pickaxe/payout with storage automaticons:farming
